...
import { LoanMockEntity } from './loan-mock.dto';

export class LoanMockMapper extends Mapper<LoanMockEntity, LoanEntity> {
  mapFrom(param: LoanMockEntity): LoanEntity {
    return {
  ...
  mapTo(param: LoanEntity): LoanMockEntity {
    return {
